...
<head>
    ...
    <title>Log in - Document Nest</title>
        ...
        <div class="space-y-6">
            ...
            <div class="relative mt-10">
                ...
                <div class="relative flex justify-center text-sm font-medium leading-6">
                    <span class="bg-white px-6 text-gray-900">Secure access</span>
                </div>
            </div>

            <p class="mt-10 text-center text-sm text-gray-500">
                Don't have an account?
                <span class="font-semibold leading-6 text-indigo-600">Google will create one for you.</span>
            </p>
        </div>
    </div>
</div>
